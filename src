...
public  class Snake extends JFrame implements KeyListener, Runnable {
    ...
    private final Point INIT_POINT = new Point(100, 150);//(x,y) initial head coordinates 
    ...
    public void init() {
        ...
        scoreViewer = new JTextArea("Play Score :: " + score);
        ...
        scorePanel.setLayout(new GridLayout(0,1));//row and column
    ...
    public void setJMenueBar(JFrame frame) {
        ...
        border.addActionListener(new ActionListener() {
         ...
         JMenuItem tunnel = new JMenuItem("TUNNEL");
        tunnel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedGameType = GAME_TYPE.TUNNEL;
                startNewGame();
            }
        });
        type.add(noMaze);
        ...
        JMenuItem creator = new JMenuItem("Developer");
        JMenuItem guideline = new JMenuItem("GuideLines");
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "Author: Dhanush R M\n\n email:rmdhanush@gmail.com");
            }
        });
        guideline.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "The player controls a square on a bordered plane. \nAs it moves forward, it leaves a tail behind,\n so that it resembles a moving snake. \nthe snake has a specific length, so there is a moving tail a fixed number of units away from the head. \nThe player loses when the snake runs into either the border of the screen or the trail left by the snake.");
            }
        });
    ...
    public void resetDefaultValues() {
        ...
        totalBodyPart = SNAKE_LENGTH_DEFAULT;//4
        directionX = SNAKE_BODY_PART_SQURE;//10
        directionY = 0;
        score = 0;
        isRunningLeft = false;
        isRunningRight = true;
    ...
    void startNewGame() {
        ...
        board.removeAll();
        createInitSnake();
        scoreViewer.setText("Play Score ::" + score);
        isRunning = true;
    }
    ...
    public void createInitSnake() {
        ...
        for (int i = 0; i < totalBodyPart; i++) {
            ...
            snakeBodyPart[i].setBackground(Color.BLUE);
    ...
    */
    ...
    /**
     *  decide what shud be done in nxt step
     */
    ...
    private boolean isGameOver(boolean isBorderTouched, int headLocX, int headLocY) {
        ...
        for (int i = SNAKE_LENGTH_DEFAULT; i < totalBodyPart - 2; i++) {
            ...
            //to check if head touches body part itself
